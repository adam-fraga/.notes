...
de pouvoir modifier les index de cette même liste en les remplaçant
par d'autres, en leur appliquant des opération mathematique ou en
les supprimant l'éxemple ci dessous illustre comment parcourir une
liste et supprimer les nombres pairs grace à la comprehension de liste.
"""
...
"""
Liste multidimensionnel ou matrice
